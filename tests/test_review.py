...
class ReviewTests(unittest.TestCase):
    def test_create_review_draft_requires_human_approval(self):
        ...
        self.assertIn("advisor_notes", draft["selected"][0])
        self.assertIn("cross_check", draft["selected"][0])
        self.assertIn("geo_risk", draft["selected"][0])
        self.assertIn("display", draft["selected"][0])
