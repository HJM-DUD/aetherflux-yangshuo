# AGENTS.md — 以太通量 / AetherFlux 项目记忆（V0.2.6）
...
│  quality.py           采集质量闸门                 │
├─────────────────────────────────────────────────┤
│  Paths（路径解析，V0.2.6 新增）                   │
│  paths.py              AETHERFLUX_DATA_ROOT 统一解析  │
├─────────────────────────────────────────────────┤
│  Scoring Layer（评分层）                          │
...
| 命令 | 说明 |
|------|------|
| `python3 -m aetherflux.cli serve` | 启动 V0.2.6 FastAPI 后台（默认 127.0.0.1:8788） |
